...
export class CpsComponent implements OnInit {
  ...
  buildReportForm(){
   ...
   this.firstNameControl.valueChanges
    ...
    this.countryControl =  this.cpsForm.get('country');
    ...
    this.countryCodeControl =  this.cpsForm.get('countryCode');
  ...
  onSubmitForm(){
    ...
    if (this.cpsForm.valid) {
      ...
      this.http.post(url, JSON.stringify(this.cpsForm.value), httpOptions)
        .subscribe(
          (val) => {
            this.formFilled = true;
  ...
  validateForm(){
    ...
    this.cpsForm.updateValueAndValidity();
  }
